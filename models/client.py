...
class Client(object):
    ...
    @classmethod
    def create_android(cls, db, client_id, xinge_access_id, xinge_secret_key, mi_appid, mi_secret_key, hw_appid,
        ...
        r = db.execute(sql, (
            client_id, now, xinge_access_id, xinge_secret_key, mi_appid, mi_secret_key, hw_appid, hw_secret_key,
            gcm_sender_id, gcm_api_key))
        return r.lastrowid
    ...
    def create_ios(cls, db, client_id, sandbox_key, sandbox_key_secret, production_key, production_key_secret):
        ...
        r = db.execute(sql,
                       (client_id, sandbox_key, sandbox_key_secret, production_key, production_key_secret, now, now))
        return r.lastrowid
    ...
    def update_ios(cls, db, client_id, sandbox_key, sandbox_key_secret, production_key, production_key_secret):
        ...
        r = db.execute(sql,
                       (sandbox_key, sandbox_key_secret, production_key, production_key_secret, now, now, client_id))
        return r.rowcount

    @classmethod
    def update_android(cls, db, client_id, xinge_access_id, xinge_secret_key, mi_appid, mi_secret_key, hw_appid,
                       hw_secret_key, gcm_sender_id, gcm_api_key):
        now = int(time.time())
        ...
        r = db.execute(sql, (
            xinge_access_id, xinge_secret_key, mi_appid, mi_secret_key, hw_appid, hw_secret_key, gcm_sender_id,
            gcm_api_key,
            now, client_id))
        return r.rowcount
